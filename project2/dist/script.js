...
/* harmony import */ var _modules_changeModuleState__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/changeModuleState */ "./src/js/modules/changeModuleState.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var deadline = '2020-09-09';
  Object(_modules_changeModuleState__WEBPACK_IMPORTED_MODULE_6__["default"])(modalState);
...
/***/ "./src/js/modules/changeModuleState.js":
/*!*********************************************!*\
  !*** ./src/js/modules/changeModuleState.js ***!
  \*********************************************/
...
var changeModuleState = function changeModuleState(state) {
...
/* harmony default export */ __webpack_exports__["default"] = (changeModuleState);
...
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modal */ "./src/js/modules/modal.js");
...
var forms = function forms(state) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      e.preventDefault();
      var statusMesage = document.createElement('div');
      ...
      postData('./assets/server.php', formData).then(function (res) {
        ...
        setTimeout(function () {
          statusMesage.remove();
          Object(_modal__WEBPACK_IMPORTED_MODULE_6__["closeModal"])('body >[class^="popup"]', 1000);
        }, 2000);
      });
    });
  });
...
function closeModal(selector, time) {
  setTimeout(function () {
    console.log(selector);
    var modal = document.querySelectorAll(selector);
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  var dispaly = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'block';
...
var timer = function timer(id, deadline) {
  ...
  var setClock = function setClock(selector, deadline) {
    var timerApp = document.querySelector(selector),
